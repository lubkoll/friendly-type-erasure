...
TEST( TestHeaderOnlyBasicFooable, Empty )
{
    Fooable fooable;
    death_tests(fooable);
...
TEST( TestHeaderOnlyBasicFooable, CopyFromValue )
{
...
TEST( TestHeaderOnlyBasicFooable, CopyConstruction )
{
...
TEST( TestHeaderOnlyBasicFooable, CopyFromValueWithReferenceWrapper )
{
    MockFooable mock_fooable;
...
TEST( TestHeaderOnlyBasicFooable, MoveFromValue )
{
    MockFooable mock_fooable;
    auto value = mock_fooable.foo();
...
TEST( TestHeaderOnlyBasicFooable, MoveConstruction )
{
    Fooable fooable = MockFooable();
    auto value = fooable.foo();
...
TEST( TestHeaderOnlyBasicFooable, MoveFromValueWithReferenceWrapper )
{
    MockFooable mock_fooable;
...
TEST( TestHeaderOnlyBasicFooable, CopyAssignFromValue )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlyBasicFooable, CopyAssignment )
{
    Fooable fooable = MockFooable();
    Fooable other;
    other = fooable;
...
TEST( TestHeaderOnlyBasicFooable, CopyAssignFromValueWithReferenceWrapper )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlyBasicFooable, MoveAssignFromValue )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlyBasicFooable, MoveAssignment )
{
    Fooable fooable = MockFooable();
    auto value = fooable.foo();
    Fooable other;
...
TEST( TestHeaderOnlyBasicFooable, MoveAssignFromValueWithReferenceWrapper )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlyBasicFooable, Cast )
{
    Fooable fooable = MockFooable();
...
TEST( TestHeaderOnlyBasicFooable, ConstCast )
{
