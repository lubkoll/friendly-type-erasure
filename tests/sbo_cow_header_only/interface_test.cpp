...
TEST( TestHeaderOnlySBOCOWFooable, Empty )
{
    Fooable fooable;
    death_tests(fooable);
...
TEST( TestHeaderOnlySBOCOWFooable, CopyFromValue_SmallObject )
{
...
TEST( TestHeaderOnlySBOCOWFooable, CopyFromValue_LargeObject )
{
...
TEST( TestHeaderOnlySBOCOWFooable, CopyConstruction_SmallObject )
{
...
TEST( TestHeaderOnlySBOCOWFooable, CopyConstruction_LargeObject )
{
...
TEST( TestHeaderOnlySBOCOWFooable, CopyFromValueWithReferenceWrapper_SmallObject )
{
    MockFooable mock_fooable;
...
TEST( TestHeaderOnlySBOCOWFooable, CopyFromValueWithReferenceWrapper_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable( std::ref(mock_fooable) );
...
TEST( TestHeaderOnlySBOCOWFooable, MoveFromValue_SmallObject )
{
    MockFooable mock_fooable;
    auto value = mock_fooable.foo();
...
TEST( TestHeaderOnlySBOCOWFooable, MoveFromValue_LargeObject )
{
    MockLargeFooable mock_fooable;
    auto value = mock_fooable.foo();
    Fooable fooable( std::move(mock_fooable) );
...
TEST( TestHeaderOnlySBOCOWFooable, MoveConstruction_SmallObject )
{
    Fooable fooable = MockFooable();
    auto value = fooable.foo();
...
TEST( TestHeaderOnlySBOCOWFooable, MoveConstruction_LargeObject )
{
    Fooable fooable = MockLargeFooable();
    auto value = fooable.foo();
    Fooable other( std::move(fooable) );
...
TEST( TestHeaderOnlySBOCOWFooable, MoveFromValueWithReferenceWrapper_SmallObject )
{
    MockFooable mock_fooable;
...
TEST( TestHeaderOnlySBOCOWFooable, MoveFromValueWithReferenceWrapper_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable( std::move(std::ref(mock_fooable)) );
...
TEST( TestHeaderOnlySBOCOWFooable, CopyAssignFromValue_SmallObject )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlySBOCOWFooable, CopyAssignFromValue_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlySBOCOWFooable, CopyAssignment_SmallObject )
{
    Fooable fooable = MockFooable();
    Fooable other;
    other = fooable;
...
TEST( TestHeaderOnlySBOCOWFooable, CopyAssignment_LargeObject )
{
    Fooable fooable = MockLargeFooable();
    Fooable other;
    other = fooable;
...
TEST( TestHeaderOnlySBOCOWFooable, CopyAssignFromValueWithReferenceWrapper_SmallObject )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlySBOCOWFooable, CopyAssignFromValueWithReferenceWrapper_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlySBOCOWFooable, MoveAssignFromValue_SmallObject )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlySBOCOWFooable, MoveAssignFromValue_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlySBOCOWFooable, MoveAssignment_SmallObject )
{
    Fooable fooable = MockFooable();
    auto value = fooable.foo();
    Fooable other;
...
TEST( TestHeaderOnlySBOCOWFooable, MoveAssignment_LargeObject )
{
    Fooable fooable = MockLargeFooable();
    auto value = fooable.foo();
    Fooable other;
...
TEST( TestHeaderOnlySBOCOWFooable, MoveAssignFromValueWithReferenceWrapper_SmallObject )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlySBOCOWFooable, MoveAssignFromValueWithReferenceWrapper_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlySBOCOWFooable, Cast_SmallObject )
{
    Fooable fooable = MockFooable();
...
TEST( TestHeaderOnlySBOCOWFooable, Cast_LargeObject )
{
    Fooable fooable = MockLargeFooable();
...
TEST( TestHeaderOnlySBOCOWFooable, ConstCast_SmallObject )
{
...
TEST( TestHeaderOnlySBOCOWFooable, ConstCast_LargeObject )
{
