...
using COWHeaderOnly::Fooable;
using Mock::MockFooable;

TEST( TestHeaderOnlyCOWFooable_HeapAllocations, Empty )
{
...
TEST( TestHeaderOnlyCOWFooable_HeapAllocations, CopyFromValue )
{
...
TEST( TestHeaderOnlyCOWFooable_HeapAllocations, CopyConstruction )
{
    auto expected_heap_allocations = 0u;
...
TEST( TestHeaderOnlyCOWFooable_HeapAllocations, CopyFromValueWithReferenceWrapper )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestHeaderOnlyCOWFooable_HeapAllocations, MoveFromValue )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestHeaderOnlyCOWFooable_HeapAllocations, MoveConstruction )
{
    auto expected_heap_allocations = 0u;
...
TEST( TestHeaderOnlyCOWFooable_HeapAllocations, MoveFromValueWithReferenceWrapper )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestHeaderOnlyCOWFooable_HeapAllocations, CopyAssignFromValue )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestHeaderOnlyCOWFooable_HeapAllocations, CopyAssignment )
{
    auto expected_heap_allocations = 0u;
...
TEST( TestHeaderOnlyCOWFooable_HeapAllocations, CopyAssignFromValuenWithReferenceWrapper )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestHeaderOnlyCOWFooable_HeapAllocations, MoveAssignFromValue )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestHeaderOnlyCOWFooable_HeapAllocations, MoveAssignment )
{
    auto expected_heap_allocations = 0u;
...
TEST( TestHeaderOnlyCOWFooable_HeapAllocations, MoveAssignFromValueWithReferenceWrapper )
{
    auto expected_heap_allocations = 1u;
