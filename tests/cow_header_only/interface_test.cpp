...
TEST( TestHeaderOnlyCOWFooable, Empty )
{
    Fooable fooable;
    death_tests(fooable);
...
TEST( TestHeaderOnlyCOWFooable, CopyFromValue )
{
...
TEST( TestHeaderOnlyCOWFooable, CopyConstruction )
{
...
TEST( TestHeaderOnlyCOWFooable, CopyFromValueWithReferenceWrapper )
{
    MockFooable mock_fooable;
...
TEST( TestHeaderOnlyCOWFooable, MoveFromValue )
{
    MockFooable mock_fooable;
    auto value = mock_fooable.foo();
...
TEST( TestHeaderOnlyCOWFooable, MoveConstruction )
{
    Fooable fooable = MockFooable();
    auto value = fooable.foo();
...
TEST( TestHeaderOnlyCOWFooable, MoveFromValueWithReferenceWrapper )
{
    MockFooable mock_fooable;
...
TEST( TestHeaderOnlyCOWFooable, CopyAssignFromValue )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlyCOWFooable, CopyAssignment )
{
    Fooable fooable = MockFooable();
    Fooable other;
    other = fooable;
...
TEST( TestHeaderOnlyCOWFooable, CopyAssignFromValueWithReferenceWrapper )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlyCOWFooable, MoveAssignFromValue )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlyCOWFooable, MoveAssignment )
{
    Fooable fooable = MockFooable();
    auto value = fooable.foo();
    Fooable other;
...
TEST( TestHeaderOnlyCOWFooable, MoveAssignFromValueWithReferenceWrapper )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestHeaderOnlyCOWFooable, Cast )
{
    Fooable fooable = MockFooable();
...
TEST( TestHeaderOnlyCOWFooable, ConstCast )
{
