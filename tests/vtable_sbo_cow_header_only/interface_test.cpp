...
TEST( TestVTableHeaderOnlySBOCOWFooable, Empty )
{
    Fooable fooable;
    death_tests(fooable);
...
TEST( TestVTableHeaderOnlySBOCOWFooable, CopyFromValue_LargeObject )
{
...
TEST( TestVTableHeaderOnlySBOCOWFooable, CopyFromValueWithReferenceWrapper_SmallObject )
{
    MockFooable mock_fooable;
...
TEST( TestVTableHeaderOnlySBOCOWFooable, CopyFromValueWithReferenceWrapper_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable( std::ref(mock_fooable) );
...
TEST( TestVTableHeaderOnlySBOCOWFooable, MoveFromValue_SmallObject )
{
    MockFooable mock_fooable;
    auto value = mock_fooable.foo();
...
TEST( TestVTableHeaderOnlySBOCOWFooable, MoveConstruction_LargeObject )
{
    Fooable fooable = MockLargeFooable();
    auto value = fooable.foo();
    Fooable other( std::move(fooable) );
...
TEST( TestVTableHeaderOnlySBOCOWFooable, MoveFromValueWithReferenceWrapper_SmallObject )
{
    MockFooable mock_fooable;
...
TEST( TestVTableHeaderOnlySBOCOWFooable, MoveFromValueWithReferenceWrapper_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable( std::move(std::ref(mock_fooable)) );
...
TEST( TestVTableHeaderOnlySBOCOWFooable, CopyAssignFromValue_SmallObject )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableHeaderOnlySBOCOWFooable, CopyAssignment_LargeObject )
{
    Fooable fooable = MockLargeFooable();
    Fooable other;
    other = fooable;
...
TEST( TestVTableHeaderOnlySBOCOWFooable, CopyAssignFromValueWithReferenceWrapper_SmallObject )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableHeaderOnlySBOCOWFooable, CopyAssignFromValueWithReferenceWrapper_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableHeaderOnlySBOCOWFooable, MoveAssignFromValue_SmallObject )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableHeaderOnlySBOCOWFooable, MoveAssignFromValue_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableHeaderOnlySBOCOWFooable, MoveAssignment_LargeObject )
{
    Fooable fooable = MockLargeFooable();
    auto value = fooable.foo();
    Fooable other;
...
TEST( TestVTableHeaderOnlySBOCOWFooable, MoveAssignFromValueWithReferenceWrapper_SmallObject )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableHeaderOnlySBOCOWFooable, MoveAssignFromValueWithReferenceWrapper_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableHeaderOnlySBOCOWFooable, Cast_SmallObject )
{
    Fooable fooable = MockFooable();
...
TEST( TestVTableHeaderOnlySBOCOWFooable, Cast_LargeObject )
{
    Fooable fooable = MockLargeFooable();
...
TEST( TestVTableHeaderOnlySBOCOWFooable, ConstCast_SmallObject )
{
...
TEST( TestVTableHeaderOnlySBOCOWFooable, ConstCast_LargeObject )
{
